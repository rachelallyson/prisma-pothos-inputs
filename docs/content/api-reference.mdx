...
When set, `prismaClientPath` is the import path to the Prisma client (e.g. `../../generated/prisma/client.js`). The generated file then types input refs as `InputTypeRef<any, Prisma.UserCreateInput>`, etc.
